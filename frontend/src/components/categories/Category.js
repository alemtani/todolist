...
const Category = memo(function Category({ category, onDelete }) {
    // Use hooks to keep track of location for onEdit
    const location = useLocation();

    // Use memo to prevent Category from constantly rerendering when passing in onDelete,
        ...
        <ListGroup.Item>
            <Stack direction="horizontal">
                ...
                <div className="ms-auto">
                    <Stack direction="horizontal" gap={3} className="align-item-center">
                        <Link as="button" to={`/categories/${category.id}/tasks`} state={{ from: location }}>
                        ...
                        <Link as="button" to={`/categories/edit/${category.id}`} state={{ from: location }}>
                        ...
                        <Button onClick={handleDelete} className="bg-danger border border-danger">
